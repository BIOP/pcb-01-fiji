...
//	lutA = makeLUTsArray();
	lutA=newArray("Fire","Grays","Ice","Spectrum","3-3-2 RGB","Red","Green","Blue", "Cyan","Magenta", "Yellow","RED/Green","16 colors","5 ramps","6 shades","blue orange icb", "brgbcmyw","cool","Cyan Hot","edges","gem","glasbey","glasbey inverted","glasbey on dark");
